...
4. **You get an email** at chris.a.wyatt@gmail.com (change this to your own when ready, your dad has the steps)
...
Customer's confirmation email has a Venmo deep link with the right amount pre-filled. They pay AFTER the job, when they're happy. Your Venmo handle is `@Elion-CarCare`. Confirm it's set up to receive.
